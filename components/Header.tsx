  ...
  return (
    ...
    >
      <div className="flex space-x-4 md:space-x-6 items-center">
        <p className="bg-[#fe921f] text-[#ffffff] inline-block font-bold text-sm leading-3 tracking-wider mx-0 my-30 px-4 py-4 uppercase rounded-tr-lg cursor-pointer hover:text-[#141414] transition-all duration-700 ">
          Night Movies
        </p>
